...
PRO hs_tweakwave, arcguess, rerun=rerun, root=root, chelle=chelle
 ...
 ;;Read the first ccd and extract the spectra
  ...
  ccdnum=1
  if keyword_set(chelle) then lampname= 'lampthar.dat' else lampname = 'lamphenear.dat'
  lamppath = getenv('HSRED_DIR') + '/etc/'
   ...
   hs_readtraceset, ccdnum, xsol=xsol, rerun=rerun
     ...
     hs_proc, arcname, ccdnum, arcimg, arcivar, rerun=rerun, root=root, chelle=chelle
