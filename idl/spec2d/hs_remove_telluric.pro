...
a_lambda=mrdfits(getenv('HSRED_DIR')+'/etc/HD-192281.fits')
a_flux=mrdfits(getenv('HSRED_DIR')+'/etc/HD-192281.fits',1)
a_ivar=mrdfits(getenv('HSRED_DIR')+'/etc/HD-192281.fits',2)
b_lambda=a_lambda
b_flux=a_flux
b_ivar=a_ivar
